...
$flickr_image_path = "admin/uploads/images/flickr/";
?>
<!-- Footer start -->
            ...
            <div class="col-md-4 col-sm-12 footer-widget">
                ...
                <div class="img-gallery">
                    <div class="img-container">
                        ...
                        <a class="thumb-holder-flikr" data-rel="prettyPhoto" href="<?php echo $flickr_image_path . $row['image']?>">
                            <?php echo '<img src = "' . $flickr_image_path . $row['image'] . '">' ?>
                        </a>
                        <?php
                            }
                        }
