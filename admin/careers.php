                                        ...
                                        <tr id="row_id_<?php echo $row['id']; ?>">
                                            ...
                                            <td>
                                                <form action=" careers_edit.php" method="post">
                                                    ...
                                                    <button type="submit" name="careers_edit_btn" class="btn btn-primary"> EDIT</button>
                                                </form>
                                            </td>
                                            <td>
                                                <input type="hidden" name="careers_delete_id" value="<?php echo $row['id']; ?>">
                                                <button type="button" class="btn btn-danger careers_delete_btn" value="<?php echo $row['id']; ?>"> DELETE</button>
                                            </td>
                                        </tr>
                                <?php
                                    }
